...
import { generateGeminiResponse } from '@/app/utils/gemini-client';

// This is a non-streaming version of the Gemini API
  ...
  try {
    ...
    try {
      ...
      const response = await generateGeminiResponse(
        ...
        programId, // pass programId for token usage logging
        modelOptions.max_completion_tokens // pass max tokens if available
      );

      console.log('Gemini response generated successfully');
      // Note: Token usage is already logged in the gemini-client.ts file
      // with a rough estimation since Gemini doesn't provide exact counts
