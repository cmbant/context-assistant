...
export default function OpenAIAssistant({
    ...
    return (
        <div className="flex flex-col bg-slate-200 shadow-md relative rounded-b-lg">
...
function OpenAIAssistantMessage({message}: {message: Message}) {
    ...
    return (
        <div className="flex rounded text-gray-700 text-center bg-white px-4 py-2 m-2 shadow-md">
            ...
            <div className="mx-4 text-left overflow-auto w-full prose max-w-none">
                <Markdown
